/*
Uso y adaptación al proyecto de la libreria AVCam-iOS desarrollada por Apple para capturar imágenes y videos.
Fuente: https://developer.apple.com/library/content/samplecode/AVCam/
...
class CameraViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Nos deshacemos temporalmente de las referencias a objetos de la interfaz gráfica del padre que no poseemos actualmente
